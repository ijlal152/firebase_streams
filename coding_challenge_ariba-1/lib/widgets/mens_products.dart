...
class MensProducts extends StatelessWidget {
  const MensProducts({super.key});
...
class MensProductsCustomWidget extends StatelessWidget {
  final String imgPath;
  final String productName;
  final String category;
  final String price;
  const MensProductsCustomWidget({
    super.key,
